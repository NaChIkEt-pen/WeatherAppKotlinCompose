...
import com.nachiket.myopenweatherapi.constant.Const.Companion.cardColor
                ...
                LazyRow(
                    ...
                    items(listForecast!!){
                        ...
                        currentItem.let {
                            ...
                            item.main.let { main ->
                                //temp = if(main == null) NA else "${main.temp} K"
                                temp = if(main?.temp == null) NA else "${DecimalFormat("#.##").format((main?.temp)?.minus(275.00))} °C"
                            ...
                            item.dt.let { dateTime ->
                                time = if(dateTime == null) NA else timeStampToHumanData(dateTime.toLong(),"EEE HH:mm")
                            }
